...
replace bidder_country="PL" if bidder_country=="Polska"
...
gen bids =bids_count
foreach var of varlist  title  tender_supplytype bid_price proc bids aw_date2 buyer_name bidder_name  {
gen ind_tr_`var'_val = 0
replace  ind_tr_`var'_val = 100 if !missing(`var') 
}
cap drop  proc aw_date2  bids impl
********************************************************************************
