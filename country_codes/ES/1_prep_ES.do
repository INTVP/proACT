...
*Data 
import delimited using  $utility_data/country/AT/starting_data/ES_data.csv, encoding(UTF-8) clear
********************************************************************************
...
sum tender_finalprice if tender_finalprice==0 //171,329
...
******************************************
save $country_folder/ES_wip.dta, replace
******************************************
...
********************************************************************************
use $country_folder/ES_wip.dta, clear
...
tab filter_ok, m  //1,760,300
count if filter_ok
di `r(N)'/_N  // 74.03% of observations
************************************
...
replace buyer_nuts="" if anb_nuts2!="ES"
