...
gen  tender_addressofimplementation2 = "["+ `"""' + tender_addressofimplementation_n + `"""' +"]"
replace tender_addressofimplementation2="" if tender_addressofimplementation_n==""
...
foreach var of varlist singleb taxhav2 nocft corr_ben {
// tab `var', m
gen ind_`var'_val = 0 
