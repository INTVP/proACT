...
*Data
use $country_folder/wb_de_cri201005c.dta, clear
********************************************************************************
...
foreach var of varlist singleb corr_decp taxhav2 corr_crit nocft {
tab `var', m
gen ind_`var'_val = 0 
...
rename bidder_name bidder_nameG
rename bidder_name_orig bidder_name

recast str818 bidder_name, force
merge m:1 bidder_name using $utility_data/country/DE/DE_sanctions.dta
drop bidder_name 
drop if _m==2
drop _m
format w_name %15s
...
br  ca_date sanct_startDate* sanct_endDate* if !missing(sanct_startDate1)
...
gen bidder_previousSanction="false"
replace bidder_previousSanction="true" if ca_dateD>=sanct_endDate1 & !missing(sanct_endDate1)
replace bidder_previousSanction="" if missing(ca_dateD)
