...
replace corr_decp=99 if decp10==99 | corr_decp==.
...
do "${utility_codes}/cri.do" singleb corr_proc_bi corr_submp_bi corr_decp_bi nocft taxhav2 proa_ycsh9 corr_ben
rename cri cri_de
