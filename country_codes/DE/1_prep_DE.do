...
*Data 
import delimited using  $utility_data/country/AT/starting_data/DE_data.csv, encoding(UTF-8) clear
********************************************************************************
...
save $country_folder/DE_wip.dta, replace
********************************************************************************
use $utility_data/wb_ppp_data.dta, clear
keep if countrycode == "DE"
drop if ppp==.
...
drop if _m==2
tabstat ppp, by(year)
replace ppp=21.20832 if missing(ppp) & year==2020 //used 2019
br year ppp if _m==3
drop _m year
...
replace buyer_nuts="" if anb_nuts2!="DE"
