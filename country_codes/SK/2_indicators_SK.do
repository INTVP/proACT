...
*Data
use $country_folder/SK_wip.dta, clear
********************************************************************************
*Single bidding
...
*************it seems we incorectly parse procedure type from 2016 onwards 

*Method 1: 
tab tender_year tender_proceduretype if filter_ok, m
* Misi: "My suggestion would be to set the missing procedure types from 2016 onwards to "small value procurement" and use it as a separate procedure type and see how it performs."
...
save $country_folder/SK_wip.dta, replace
...
********************************************************************************
save $country_folder/SK_wb_1120.dta, replace
********************************************************************************
*CRI calculation
