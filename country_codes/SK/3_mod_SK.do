...
foreach var of varlist corr_nocft singleb taxhav2  {
// tab `var', m
gen ind_`var'_val = 0 
...
// foreach var of varlist tender_awarddecisiondate tender_contractsignaturedate tender_biddeadline tender_publications_firstcallfor tender_publications_firstdcontra {
// split(`var'),p(".")
