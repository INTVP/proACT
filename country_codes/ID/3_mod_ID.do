...
*Data
use "${country_folder}/`country'_wb_2012.dta", clear
********************************************************************************
...
foreach var of varlist anb_name {
decode `var', gen(`var'2)
replace `var'2="" if `var'2=="."
drop `var' 
rename `var'2 `var'
...
replace ten_title = proper(ten_title)
replace ten_title = ustrupper(ten_title)
************************************

decode ca_procedure_nat, gen(ca_procedure_nat2)
replace ca_procedure_nat2="" if ca_procedure_nat2=="."
drop ca_procedure_nat 
rename ca_procedure_nat2 tender_nationalproceduretype
************************************
*Countries
...
foreach var of varlist singleb nocft corr_proc {
// tab `var', m
gen ind_`var'_val = 0 
...
cap drop impl  proc aw_date2  bids bid_price title bidder_name
********************************************************************************
...
keep ten_id bid_iswinning tender_country aw_dec_date ca_signdate  cft_deadline tender_nationalproceduretype tender_proceduretype tender_supplytype tender_publications_notice_type cft_date_first cft_url source tender_publications_award_type ca_url buyer_masterid buyer_id buyer_loc_2 buyer_postal_code buyer_country buyer_geocodes buyer_name  buyer_buyertype bidder_masterid bidder_id   bidder_name bid_priceUsd ca_contract_value bid_pricecurrency lot_productCode lot_localProductCode_type lot_localProductCode ten_title lot_estimatedpriceUsd ca_tender_est_value lot_est_pricecurrency ind_nocft_val ind_nocft_type ind_singleb_val ind_singleb_type ind_taxhav_val ind_taxhav2_type decp ind_corr_decp_val ind_corr_decp_type ind_corr_proc_val ind_corr_proc_type submp ind_corr_submp_val ind_corr_submp_type ind_corr_ben_val ind_corr_ben_type ind_csh_val ind_csh_type ind_tr_buyer_name_val ind_tr_buyer_name_type ind_tr_title_val ind_tr_tender_title_type ind_tr_bidder_name_val ind_tr_bidder_name_type ind_tr_tender_supplytype_val ind_tr_tender_supplytype_type ind_tr_bid_price_val ind_tr_bid_price_type ind_tr_impl_val ind_tr_impl_type ind_tr_proc_val ind_tr_proc_type ind_tr_bids_val ind_tr_bids_type ind_tr_aw_date2_val ind_tr_aw_date2_type ind_comp_bidder_mkt_share_val ind_comp_bidder_mkt_share_type ind_comp_bids_count_val ind_comp_bids_count_type ind_comp_bidder_mkt_entry_val ind_comp_bidder_mkt_entry_type ind_comp_bidder_non_local_val ind_comp_bidder_non_local_type is_capital  


append using "${utility_data}/country/`country'/indonesia_raw200316_losing_bids.dta", gen(appended)
********************************************************************************
...
************************************
ren ten_id tender_id
ren aw_dec_date tender_awarddecisiondate
ren ca_signdate tender_contractsignaturedate
ren cft_date_first cft_date
ren buyer_loc_2 buyer_city
ren buyer_postal_code buyer_postcode
ren ten_title tender_title

keep tender_id lot_number bid_number bid_iswinning tender_country tender_awarddecisiondate tender_contractsignaturedate  cft_deadline tender_nationalproceduretype tender_proceduretype tender_supplytype tender_publications_notice_type cft_date cft_url source tender_publications_award_type ca_url buyer_masterid buyer_id buyer_city buyer_postcode buyer_country buyer_geocodes buyer_name buyer_buyertype bidder_masterid bidder_id bidder_name bid_priceUsd ca_contract_value bid_pricecurrency lot_productCode lot_localProductCode_type lot_localProductCode ten_title lot_estimatedpriceUsd ca_tender_est_value lot_est_pricecurrency ind_nocft_val ind_nocft_type ind_singleb_val ind_singleb_type ind_taxhav_val ind_taxhav2_type decp ind_corr_decp_val ind_corr_decp_type ind_corr_proc_val ind_corr_proc_type submp ind_corr_submp_val ind_corr_submp_type ind_corr_ben_val ind_corr_ben_type ind_csh_val ind_csh_type ind_tr_buyer_name_val ind_tr_buyer_name_type ind_tr_title_val ind_tr_tender_title_type ind_tr_bidder_name_val ind_tr_bidder_name_type ind_tr_tender_supplytype_val ind_tr_tender_supplytype_type ind_tr_bid_price_val ind_tr_bid_price_type ind_tr_impl_val ind_tr_impl_type ind_tr_proc_val ind_tr_proc_type ind_tr_bids_val ind_tr_bids_type ind_tr_aw_date2_val ind_tr_aw_date2_type ind_comp_bidder_mkt_share_val ind_comp_bidder_mkt_share_type ind_comp_bids_count_val ind_comp_bids_count_type ind_comp_bidder_mkt_entry_val ind_comp_bidder_mkt_entry_type ind_comp_bidder_non_local_val ind_comp_bidder_non_local_type is_capital  
...
********************************************************************************
*Clean up
copy "${country_folder}/`country'_wb_2012.dta" "${utility_data}/country/`country'/`country'_wb_2012.dta", replace
