...
*Data 
import delimited using  $utility_data/country/AT/starting_data/LU_data.csv, encoding(UTF-8) clear
********************************************************************************

*Filter ok main - not missing bidder name

tab bid_iswinning , m //no losing
tab bid_iscons , m //only 230 obs 
tab tender_isframe , m //~5k
...
gen anb_location1=buyer_nuts if regex(buyer_nuts,"^LU") 
replace anb_location1="EXT" if regex(anb_location1,"^LU")==0 & !missing(buyer_nuts)
