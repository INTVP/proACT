...
*Data
use $country_folder/LU_wip.dta, clear
********************************************************************************
...
*Level 1 risk - NEGOTIATED_WITHOUT_PUBLICATION,  Missing
*Level 2 risk -  OUTRIGHT_AWARD

label list ca_procedure2
cap drop corr_proc
gen corr_proc=.
replace corr_proc=0 if inlist(ca_procedure,1,2,4,6,7,9) 
replace corr_proc=1 if inlist(ca_procedure,3,5)
...
sum submp if filter_ok  //mean 69 days
xtile submp10=submp if filter_ok==1, nquantiles(10)
replace submp10=99 if submp==.
tabstat submp, by(submp10) stat(min mean max)

logit singleb ib8.submp10 i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High Risk: 1,2,3, NA
logit singleb ib9.submp10 i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High Risk: 1,2,3, NA

cap drop corr_submp
gen corr_submp=0
replace corr_submp=1 if inlist(submp10,1,2,3,99)
...
sum decp if filter_ok //mean: 116.4.6 days
tabstat decp, by(decp10) stat(n min mean max)

logit singleb ib6.decp10 i.corr_submp i.corr_proc i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High risk: 1
*Med risk 2-5, NA
logit singleb ib7.decp10 i.corr_submp i.corr_proc i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base

gen corr_decp=0
replace corr_decp=1 if inlist(decp10,2,3,4,5,99)
...
logit singleb i.nocft i.corr_decp i.corr_submp i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*not valid
logit singleb i.nocft##i.corr_proc i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*not valid
drop nocft
...
*Not valid
logit singleb i.nocft2##i.corr_proc i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Not valid
drop nocft2
*Not using nocft
********************************************************************************
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="LU" | bidder_country==""
tab fsuppl, missing
...
logit singleb i.taxhav i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
logit singleb i.taxhav2 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
logit singleb i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*YES
*Valid -  use taxhav2
********************************************************************************
...
*Nothing valid
reg w_ycsh singleb  i.taxhav3 i.corr_proc  i.corr_decp i.anb_location i.corr_submp i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
*Nothing valid
...
save $country_folder/LU_wip.dta, replace
...
logit singleb i.corr_ben i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*doesn't work
tabstat MAD, by(MAD_conformitiy) stat(min mean max)

xtile ben=MAD if filter_ok==1, nquantiles(10)
replace ben=99 if MAD==. 
tabstat MAD if filter_ok, stat(mean median) //mean .0259305 median .0162697
tabstat MAD, by(ben) stat(min max)

*compared to mean
logit singleb ib6.ben  i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*nothing works
logit singleb ib7.ben  i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*nothing works
*compared to median
logit singleb ib4.ben  i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*nothing works
...
*R2 18.98%, 10,106 obs
********************************************************************************
save $country_folder/LU_wb_2011.dta, replace
********************************************************************************
*CRI calculation
sum singleb corr_proc taxhav2 corr_submp corr_decp  proa_ycsh if filter_ok==1
tab singleb, m
tab taxhav2, m
...
do $utility_codes/cri.do singleb corr_proc_bi corr_subm corr_decp_bi proa_ycsh4 taxhav2
rename cri cri_lu

sum cri_lu if filter_ok==1
hist cri_lu if filter_ok==1, title("CRI LU, filter_ok")
hist cri_lu if filter_ok==1, by(tender_year, noiy title("CRI LU (by year), filter_ok")) 
********************************************************************************
