...
*Data
use $country_folder/LU_wb_2011.dta, clear
********************************************************************************
...
drop market_id_star
split tender_cpvs, p(",")
drop tender_cpvs2-tender_cpvs30
...
/*
Quick check with bence
keep if x>1
keep tender_id lot_row_nr tender_lotscount lot_row_nr tender_isframe bid_iscons tender_title lot_title bidder_name bid_price *cons* tender_publications_lastcontract notice_url 
br tender_id lot_row_nr tender_lotscount lot_row_nr tender_isframe bid_iscons tender_title lot_title bidder_name bid_price *cons* tender_publications_lastcontract notice_url
gen x=_n
keep if x<=214
drop x 
export delimited "C:\Our folders\Aly\WB portals\output\LU\LU_sample.csv", replace
*/

format tender_title bidder_name lot_title  tender_publications_lastcontract  %15s
br x tender_id lot_row_nr tender_lotscount lot_row_nr tender_isframe bid_iscons tender_title lot_title bidder_name bid_price *cons* tender_publications_lastcontract notice_url if x>1
...
export delimited $country_folder/LU_mod.csv, replace
********************************************************************************
*END