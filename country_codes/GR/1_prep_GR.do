...
*Data 
import delimited using  $utility_data/country/AT/starting_data/GR_data.csv, encoding(UTF-8) clear
********************************************************************************
...
tab bid_iswinning if tender_finalprice==0 
tab tender_proceduretype if tender_finalprice==0 //mostly open
...
save $country_folder/GR_wip.dta, replace
********************************************************************************
...
use $country_folder/GR_wip.dta,clear
...
*Buyer Location
tab buyer_nuts, m
gen anb_nuts2 = substr(buyer_nuts,1,3)
*replace buyer_nuts="" if anb_nuts2!="GR"
encode anb_nuts2,gen(anb_loc)
********************************************************************************
