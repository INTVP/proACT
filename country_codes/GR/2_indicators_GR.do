...
tab singleb
tab singleb if filter_ok , missing  //22.55% singlebidding
******************************************
...
do $utility_codes/cri.do singleb nocft corr_proc_bi corr_submp corr_decp_bi corr_awcrit corr_crit corr_ben2 proa_ycsh4 
rename cri cri_gr
