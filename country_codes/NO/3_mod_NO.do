...
merge m:1 nutscode using "${utility_data}/nuts_map.dta"
drop if _m==2
// tab tender_addressofimplementation_n if _m==1  
replace tender_addressofimplementation_n="" if _m==1 & regex(tender_addressofimplementation_n,"^NO")==0
// drop description nutscode _merge
...
foreach var of varlist singleb nocft corr_ben {
// tab `var', m
gen ind_`var'_val = 0 
...
gen ind_tax_hav2_val = .


foreach var of varlist corr_submp corr_proc corr_decp {
// tab `var', m
