...
foreach var of varlist buyer_nuts bidder_nuts tender_addressofimplementation_n {
replace `var'="" if `var'=="00"   
}
...
*unicode convertfile "${country_folder}/`country'_mod.csv" "${country_folder}/`country'_mod.csv", dstencoding(utf-8) replace
********************************************************************************
*Clean up
