...
*Data 
import delimited using  $utility_data/country/AT/starting_data/FI_data.csv, encoding(UTF-8) clear
********************************************************************************

*Filter ok main - not missing bidder name

tab bid_iswinning , m //no losing
tab bid_iscons , m // 3,118 obs 
...
tab filter_ok, m
*35% removed, all due to missing bidder name
************************************
...
gen anb_location1=substr(buyer_nuts,1, 4) 
replace anb_location1="FI2" if anb_location1=="FIZ" | anb_location1=="FI20"
replace anb_location1="EXT" if regex(anb_location1,"FI")==0 & !missing(buyer_nuts)
