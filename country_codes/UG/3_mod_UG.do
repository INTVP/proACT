...
*Data
use "${country_folder}/`country'_wb_2011.dta"
********************************************************************************
*Fixing variables for reverse tool

gen tender_country = "UG"

replace buyer_country = "UG" if buyer_country=="Uganda"

cap drop iso
gen iso = bidder_country
do "${utility_codes}/country-to-iso.do" bidder_country
rename bidder_country bidder_country_full
rename iso bidder_country
************************************
...
gen ind_tr_buyer_name_type = "TRANSPAREN`country'_BUYER_NAME_MISSING"
gen ind_tr_tender_title_type = "TRANSPAREN`country'_TITLE_MISSING"
gen ind_tr_bidder_name_type = "TRANSPAREN`country'_BIDDER_NAME_MISSING"
gen ind_tr_tender_supplytype_type = "TRANSPAREN`country'_SUPPLY_TYPE_MISSING"
gen ind_tr_bid_price_type = "TRANSPAREN`country'_VALUE_MISSING"
gen ind_tr_impl_type = "TRANSPAREN`country'_IMP_LOC_MISSING"
gen ind_tr_proc_type = "TRANSPAREN`country'_PROC_METHOD_MISSING"
gen ind_tr_bids_type = "TRANSPAREN`country'_BID_NR_MISSING"
gen ind_tr_aw_date2_type = "TRANSPAREN`country'_AWARD_D`country'E_MISSING"
...
foreach var of varlist singleb roverrun_bi corr_decp corr_proc nocft {
// tab `var', m
gen ind_`var'_val = 0
...
gen ind_taxhav2_val=.
gen ind_roverrun2_val = ind_roverrun_bi_val

************************************
*For indicators with categories

foreach var of varlist corr_submp {
// tab `var', m
