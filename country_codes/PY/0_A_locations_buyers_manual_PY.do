...
*Data 
import delimited using $utility_data/country/PY//starting_data/PY_data_Datlab_output_20200803.csv, encoding(UTF-8)  varnames(1) clear 
********************************************************************************
...
save $country_folder/PY_no_dup.dta, replace
**************************************************************************
use  $country_folder/PY_no_dup.dta, clear

matchit unique_name anb_name_edit using $utility_data/country/PY/PY_locations_archive_strategic_sourcing.dta , idusing(unique_name_loc) txtusing(anb_name_edit_loc) sim(token) w(root) score(jaccard) g(simil_token) stopw swt(0.9) time flag(10) t(0.5) over  
...
********************************************************************************
*Merge location data to the matches
use $country_folder/PY_loc_matches1.dt, clear

merge m:1 unique_name_loc using $utility_data/country/PY/PY_locations_archive_strategic_sourcing.dta , generate(_m)
keep if _m==3
...
merge m:1 unique_name using $country_folder/PY_loc_matches2.dta, generate(_m)
...
*Match Fixes - manually collected 
...
merge m:1 anb_name using $utility_data/country/PY/PY_locations_manual.dta, generate(_m)
...
drop anb_name
rename anb_name_orig anb_name
br anb_name anb_city anb_dept anb_country anb_country_iso2 anb_dept_iso anb_city_iso if !missing(anb_city)
********************************************************************************
save $country_folder/PY_wip.dta, replace
********************************************************************************
*END