...
cap drop tender_addressofimplementation_c
...
drop market_id_star
split tender_cpvs, p(",")
drop tender_cpvs2-tender_cpvs35
...
foreach var of varlist corr_proc singleb roverrun2 nocft2 {
// tab `var', m
gen ind_`var'_val = 0 
...
foreach var of varlist corr_submp corr_decp corr_ben {
// tab `var', m
