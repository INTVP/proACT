...
*Data
use $country_folder/BE_wip.dta, clear
********************************************************************************
...
*Level 1 risk - RESTRICTED, NEGOTIATED,COMPETITIVE_DIALOG
*Level 2 risk - NEGOTIATED_WITHOUT_PUBLICATION, OUTRIGHT_AWARD
label list ca_procedure2
gen corr_proc=.
replace corr_proc=0 if inlist(ca_procedure,2,6,7) 
replace corr_proc=1 if inlist(ca_procedure,4,9,1)
replace corr_proc=2 if inlist(ca_procedure,5,8) 
...
sum submp if filter_ok  //mean 73 days
...
logit singleb ib10.submp10 i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
...
logit singleb ib5.submp5 i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*not valid
...
logit singleb ib6.decp10 i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*<=6

gen corr_decp=0
replace corr_decp=1 if inlist(decp10,4,5)
...
logit singleb i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid!
********************************************************************************
...
logit singleb i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="BE" | bidder_country==""
tab fsuppl, missing
...
logit singleb i.taxhav i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
logit singleb i.taxhav2 i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Both are not valid
...
tab taxhav3, m
logit singleb i.taxhav3 i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
...
reg w_ycsh singleb i.taxhav i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>2 & w_ynrc!=., base
reg w_ycsh singleb i.taxhav i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
reg w_ycsh singleb i.taxhav i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>9 & w_ynrc!=., base
*does not work
...
save $country_folder/BE_wip.dta, replace
...
merge m:1 buyer_id using buyers_benford.dta
drop if _m==2
drop _m
drop buyer_id
...
logit singleb i.corr_ben i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Doesn't work 

xtile ben=MAD if filter_ok==1, nquantiles(10)
replace ben=99 if MAD==. 
mean MAD if filter_ok //.0237645 mean
tabstat MAD, by(ben) stat(min max)
logit singleb ib7.ben i.nocft i.corr_decp i.corr_proc i.anb_type i.ca_type i.tender_year i.market_id  i.cvalue10  if filter_ok , base
logit singleb ib1.ben i.nocft i.corr_decp i.corr_proc i.anb_type i.ca_type i.tender_year i.market_id  i.cvalue10  if filter_ok , base
*Does not work
********************************************************************************
...
reg proa_ycsh singleb i.taxhav i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>4 & proa_ynrc!=., base
outreg2 using se_valid2.doc

*Calc from buyer side more valid than calc from winner side. 
********************************************************************************

save $country_folder/BE_wb_1020.dta, replace
********************************************************************************

*CRI calculation

sum singleb corr_proc corr_decp nocft proa_ycsh if filter_ok==1
tab singleb, m
...
do $utility_codes/cri.do singleb corr_proc_bi corr_decp_bi nocft proa_ycsh4 
rename cri cri_be

sum cri_be if filter_ok==1
hist cri_be if filter_ok==1, title("CRI BE, filter_ok")
hist cri_be if filter_ok==1, by(tender_year, noiy title("CRI SE (by year), filter_ok")) 
********************************************************************************
