...
*Data 
import delimited using  $utility_data/country/AT/starting_data/HU_data.csv, encoding(UTF-8) clear
********************************************************************************
...
*tender_digiwhist_price & bid_digiwhist_price are in EUR
*Fix currency
...
drop if ppp==.
keep year ppp
save $country_folder/ppp_data_hu.dta
********************************************************************************
