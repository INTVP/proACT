...
*Data
use"${country_folder}/`country'_wb_201207.dta", clear
********************************************************************************
...
************************************
*rename buyer_NUTS buyer_geocodes

// tab buyer_nuts, m

gen  buyer_geocodes = "["+ `"""' + buyer_nuts + `"""' +"]"
cap drop buyer_nuts_len
...
foreach var of varlist singleb corr_submp nocft corr_proc corr_ben5 {
// tab `var', m
gen ind_`var'_val = 0 
...
********************************************************************************
*Clean up
copy "${country_folder}/`country'_wb_201207.dta" "${utility_data}/country/`country'/`country'_wb_201207.dta", replace
