...
*Data
use $country_folder/SE_wb_1020.dta, clear
********************************************************************************
...
foreach var of varlist nocft singleb corr_submp taxhav{
tab `var', m
gen ind_`var'_val = 0 
...
export delimited $country_folder/SE_mod.csv, replace
********************************************************************************
*END