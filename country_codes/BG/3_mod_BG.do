...
*Data
use $country_folder/BG_wb_1020.dta, clear
********************************************************************************
...
foreach var of varlist corr_decp corr_submp corr_proc corr_ben{
tab `var', m
...
replace tender_addressofimplementation_n="" if regex(tender_addressofimplementation_n,"Hlavné|obstarávania") & filter_ok
...
drop ind_nocft_val
*gen ind_taxhav2_val = ind_taxhav_val
*drop ind_taxhav_val

*gen ind_corr_ben_val = .
*drop ind_corr_ben_type
gen ind_tr_title_val = ind_tr_tender_title_val
drop ind_tr_tender_title_val
*gen ind_corr_ben_val =.
********************************************************************************

keep tender_id bid_number lot_number tender_awarddecisiondate tender_contractsignaturedate tender_proceduretype  tender_publications_firstcallfor notice_url source   tender_publications_firstdcontra  tender_publications_lastcontract  buyer_masterid buyer_id buyer_city  buyer_country buyer_geocodes buyer_name bidder_masterid bidder_id bidder_country bidder_geocodes bidder_name bid_priceUsd bids_count ind_corr_nocft_val ind_singleb_val ind_taxhav2_val ind_corr_decp_val ind_corr_proc_val ind_corr_submp_val ind_corr_ben_val ind_csh_val ind_tr_buyer_name_val ind_tr_title_val  ind_tr_bidder_name_val ind_tr_tender_supplytype_val ind_tr_bid_price_val ind_tr_impl_val ind_tr_proc_val ind_tr_bids_val ind_tr_aw_date2_val 
...
export delimited $country_folder/BG_mod_ind.csv, replace
********************************************************************************