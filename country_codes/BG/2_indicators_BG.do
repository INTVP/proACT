...
*Data
use $country_folder/BG_wip.dta, clear
********************************************************************************
...
tab buyer_nuts
tab tender_addressofimplementation_n

*Controls only 
*logit singleb lca_contract_value i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
//R2: 16% - 134k obs


*logit singleb i.cvalue10 i.anb_loc i.anb_type i.anb_loc i.ca_type i.tender_year i.market_id  if filter_ok, base
*drop cvalue10
//R2: 16% - 151k obs
...
tab tender_nationalproceduretype tender_proceduretype, m
...
*logit singleb ib8.ca_procedure i.cvalue10  i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
**logit singleb ib7.ca_procedure i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Based on regressions 
*Level 1 risk - OPEN
*Level 1 risk - NEGOTIATED, NA,NEGOTIATED_WITH_PUBLICATION, RESTRICTED
*Level 2 risk - NEGOTIATED_WITHOUT_PUBLICATION, OUTRIGHT_AWARD, COMPETITIVE_DIALOG

label list ca_procedure2
gen corr_proc=0
*replace corr_proc=0 if inlist(ca_procedure,1,3,7,8,11,12) 
replace corr_proc=1 if inlist(ca_procedure,3,4,6,9)
replace corr_proc=2 if inlist(ca_procedure,5,8,1) 
*replace corr_proc=99 if ca_procedure==2
tab ca_procedure corr_proc if filter_ok
*logit singleb i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Much better
...
*logit singleb i.nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid

*logit singleb i.nocft##i.corr_proc i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid for corr_proc == 1 & 2
/*
rename nocft nocft2
...
*/
gen corr_nocft = 0
replace corr_nocft=1 if nocft==1 & corr_proc==1
replace corr_nocft=2 if nocft==1 & corr_proc==2

*logit singleb i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base

********************************************************************************

*Testing submission period

sum submp if filter_ok  //mean 74.8 days
xtile submp10=submp if filter_ok==1, nquantiles(10)
replace submp10=99 if submp==.
tabstat submp, by(submp10) stat(min mean p50 max)

*logit singleb ib9.submp10 i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id if filter_ok, base
*logit singleb ib6.submp10 i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id if filter_ok, base
*logit singleb ib10.submp10 i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id if filter_ok, base

xtile submp5=submp if filter_ok==1, nquantiles(5)
replace submp5=99 if submp==.
tabstat submp, by(submp5) stat(min mean max)

*logit singleb ib4.submp5 i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*logit singleb ib5.submp5 i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base

*drop corr_submp
gen corr_submp=0
replace corr_submp=1 if inlist(submp5,1,2)
replace corr_submp=2 if inlist(submp10,7,8,9)
replace corr_submp=99 if submp5==99
*tab submp10 corr_submp if filter_ok, missing

*logit singleb i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
...
sum decp if filter_ok //mean: 68 days
tabstat decp, by(decp10) stat(min mean max)

*logit singleb ib6.decp10 i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*<=6
...
*logit singleb ib4.decp5 i.corr_submp i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*/

gen corr_decp=0
replace corr_decp=1 if inlist(decp10,4)
replace corr_decp=2 if inlist(decp10,1,2,3)
replace corr_decp=99 if decp10==99
tab decp10 corr_decp if filter_ok, missing
*tab decp10 nocft if filter_ok, m
*tabstat decp, by(decp5) stat(min mean max)

*logit singleb i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid!
********************************************************************************
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="BG" | bidder_country==""
tab fsuppl, missing
...
*logit singleb i.taxhav i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*logit singleb i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*taxhav2 works, too few cases though
...
tab taxhav3, m
*logit singleb i.taxhav3 i.corr_decp i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*In this format taxhaven works, but making all foreign suppliers risky doesn't make much sense
********************************************************************************
*/
...
sum bidder_id buyer_id tender_year
br *id*
*masterid should be used instead

egen w_yam=sum(bid_price) if filter_ok==1 & bidder_masterid!="" & tender_year!=., by (bidder_masterid) 
...
reg w_ycsh singleb i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>2 & w_ynrc!=., base
reg w_ycsh singleb i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
reg w_ycsh singleb i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>9 & w_ynrc!=., base
...
gen buyer_id_temp = "f" + buyer_masterid
rename buyer_masterid buyer_id_old
*br buyer_name buyer_id_temp buyer_id_old
save $country_folder/BG_wip.dta, replace

preserve
    rename buyer_id_temp buyer_masterid //buyer id variable
...
use $country_folder/BG_wip.dta, clear
rename buyer_id_temp buyer_masterid
merge m:1 buyer_masterid using buyers_benford.dta
drop if _m==2
drop _m
drop buyer_masterid
rename buyer_id_old buyer_masterid
...
*logit singleb i.corr_ben i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Works

xtile ben=MAD if filter_ok==1, nquantiles(10)
replace ben=99 if MAD==. 
mean MAD if filter_ok //.0151264   mean
tabstat MAD, by(ben) stat(min max)
*logit singleb ib7.ben i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*logit singleb ib1.ben i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Does not work
********************************************************************************
...
*reg w_ycsh singleb i.taxhav3 i.nocft i.corr_decp i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
reg proa_ycsh singleb i.taxhav2 i.corr_decp i.corr_submp i.corr_nocft i.corr_proc i.cvalue10 i.anb_loc i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>4 & proa_ynrc!=., base
outreg2 using se_valid2.doc

*Calc from buyer side more valid than calc from winner side. 
********************************************************************************
save $country_folder/BG_wb_1020.dta, replace

********************************************************************************
*CRI calculation

sum singleb corr_proc corr_submp corr_decp corr_nocft taxhav2 proa_ycsh if filter_ok==1
tab singleb, m
tab corr_proc, m //rescale
tab corr_submp, m //rescale
tab corr_decp, m //rescale
tab corr_nocft, m //rescale
tab taxhav2, m
*tab corr_ben, m //rescale
*tab proa_ycsh, m

gen corr_nocft_bi=99
replace corr_nocft_bi=nocft/2 if nocft!=99
tab corr_nocft_bi nocft
...
do $utility_codes/cri.do  singleb corr_proc_bi corr_submp_bi corr_decp_bi corr_nocft_bi taxhav2 proa_ycsh4
rename cri cri_bg

sum cri_bg if filter_ok==1
hist cri_bg if filter_ok==1, title("CRI BG, filter_ok")
hist cri_bg if filter_ok==1, by(tender_year, noiy title("CRI BG (by year), filter_ok")) 
********************************************************************************
