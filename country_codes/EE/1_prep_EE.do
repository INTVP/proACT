...
*Data 
import delimited using  $utility_data/country/AT/starting_data/EE_data.csv, encoding(UTF-8) clear
********************************************************************************
...
tab curr if filter_ok
save $country_folder/EE_wip.dta , replace

********************************************************************************
*Inidcator name: PPP conversion factor, GDP (LCU per international $)
*use "C:\GTI\WB_portal\extra_files\wb_ppp_data", clear
/*
keep if inlist(countryname,"Sweden")
drop if ppp==.
keep year ppp
save ppp_data_skk.dta,replace
*/
