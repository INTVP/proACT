...
*Data
use $utility_data/country/UY/starting_data/dfid2_cri_uy20212.dta, clear
********************************************************************************
/*Notes
...
merge m:1 aw_item_class_id using $utility_data/country/UY/product_correspondance_UY.dta
drop if _m==2
drop _m
sort cpv_div
