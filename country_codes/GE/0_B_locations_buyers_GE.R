...
Sys.setlocale("LC_CTYPE", "georgian")
library("dplyr", lib.loc="~/R/win-library/3.6")

df_city <- read.csv("GE_city.csv", encoding = "UTF-8")
...
get_url <- function(x, language = tolower('en')) {
  # generate a url for HERE api geo mapping
  apiKey <- 'xxxx'  #Generate an API key
...
cities_out$api_city[grepl("^1001$", cities_out$id_city)] <- "Batumi"
cities_out$api_county[grepl("^1001$", cities_out$id_city)] <- "Acharis Avtonomiuri Respublika"
cities_out$api_state[grepl("^1001$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^1001$", cities_out$id_city)] <- "Batumi"
cities_out$api_country[grepl("^1001$", cities_out$id_city)] <- "NA"


cities_out$api_city[grepl("^1000$", cities_out$id_city)] <- "Poti"
cities_out$api_county[grepl("^1000$", cities_out$id_city)] <- "Samegrelo-Zemo Svaneti"
cities_out$api_state[grepl("^1000$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^1000$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^1000$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^955$", cities_out$id_city)] <- "Tbilisi"
cities_out$api_county[grepl("^955$", cities_out$id_city)] <- "Tbilisi"
cities_out$api_state[grepl("^955$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^955$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^955$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^1059$", cities_out$id_city)] <- "Chkhorotsku"
cities_out$api_county[grepl("^1059$", cities_out$id_city)] <- "Samegrelo-Zemo Svaneti"
cities_out$api_state[grepl("^1059$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^1059$", cities_out$id_city)] <- "Chkhorotsku"
cities_out$api_country[grepl("^1059$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^1066$", cities_out$id_city)] <- "Tsalka"
cities_out$api_county[grepl("^1066$", cities_out$id_city)] <- "Kvemo Kartli"
cities_out$api_state[grepl("^1066$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^1066$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^1066$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^1064$", cities_out$id_city)] <- "Tsalenjikha"
cities_out$api_county[grepl("^1064$", cities_out$id_city)] <- "Samegrelo-Zemo Svaneti"
cities_out$api_state[grepl("^1064$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^1064$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^1064$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^106$", cities_out$id_city)] <- "Zugdidi"
cities_out$api_county[grepl("^106$", cities_out$id_city)] <- "Samegrelo-Zemo Svaneti"
cities_out$api_state[grepl("^106$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^106$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^106$", cities_out$id_city)] <- "NA"

cities_out$api_city[grepl("^33$", cities_out$id_city)] <- "Gardabani"
cities_out$api_county[grepl("^33$", cities_out$id_city)] <- "Kvemo Kartli"
cities_out$api_state[grepl("^3$", cities_out$id_city)] <- "NA"
cities_out$api_district[grepl("^33$", cities_out$id_city)] <- "NA"
cities_out$api_country[grepl("^33$", cities_out$id_city)] <- "NA"

cities_out$api_country[grepl("^na$", cities_out$city_country)] <- "NULL"
...
cities_out$api_country[grepl("^ERROR", cities_out$api_state)] <- NA


setwd("") # Enter working directory
write.csv2(cities_out,"GE_city_fromAPI.csv", fileEncoding = "UTF-8")
