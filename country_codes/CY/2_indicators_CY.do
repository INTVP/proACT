...
*Data
use $country_folder/CY_wip.dta, clear
********************************************************************************
...
logit singleb i.anb_type i.ca_type i.tender_year i.market_id  i.ca_contract_value10 if filter_ok, base
//R2: 20.7% - 8,402 obs
********************************************************************************
...
logit singleb ib6.ca_procedure i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Based on regressions 
*Level 1 risk - Missing
*Level 2 risk - NEGOTIATED_WITHOUT_PUBLICATION,  
label list ca_procedure2
cap drop corr_proc
gen corr_proc=.
replace corr_proc=0 if inlist(ca_procedure,1,3,5,6,7) 
replace corr_proc=1 if inlist(ca_procedure,4)
replace corr_proc=2 if inlist(ca_procedure,2)
*replace corr_proc=99 if ca_procedure==2
	
logit singleb i.corr_proc i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*valid 
********************************************************************************
...
sum submp if filter_ok  //mean 105.5 days
xtile submp10=submp if filter_ok==1, nquantiles(10)
replace submp10=99 if submp==.
tabstat submp, by(submp10) stat(min mean max)

logit singleb ib7.submp10 i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Med Risk : 10
*High Risk: 1,2,3

gen corr_submp=0
replace corr_submp=1 if inlist(submp10,10)
replace corr_submp=2 if inlist(submp10,1,2,3)
...
logit singleb i.corr_submp i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
tabstat submp, by(submp10) stat(min mean max)
...
sum decp if filter_ok //mean: 105.6 days
tabstat decp, by(decp10) stat(n min mean max)

logit singleb ib7.decp10 i.corr_submp i.corr_proc i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High risk: 1
*Med risk 2

gen corr_decp=0
replace corr_decp=1 if inlist(decp10,2)
replace corr_decp=2 if inlist(decp10,1)
...
logit singleb i.corr_decp i.corr_submp i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid!
********************************************************************************
...
logit singleb i.nocft i.corr_decp i.corr_submp i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*not valid
logit singleb i.nocft##i.corr_proc i.corr_decp i.corr_submp i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*not valid
...
logit singleb i.nocft2 i.corr_decp i.corr_submp i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Not valid
*Not using nocft
********************************************************************************
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="CY" | bidder_country==""
tab fsuppl, missing
...
logit singleb i.taxhav i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
logit singleb i.taxhav2 i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
logit singleb i.taxhav3 i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO

*Don't use taxhav2 for CRI
********************************************************************************
...
reg w_ycsh singleb  i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>2 & w_ynrc!=., base
*singleb, proc 1/2 sub, not sig dec
reg w_ycsh singleb  i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
*singleb, proc 1/2 sub, not sig dec
reg w_ycsh singleb  i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>9 & w_ynrc!=., base
...
*validation 
reg proa_ycsh singleb  i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>2 & proa_ynrc!=., base
* 1/2 dec
reg proa_ycsh singleb  i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>4 & proa_ynrc!=., base
*1/2 dec
reg proa_ycsh singleb i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>9 & proa_ynrc!=., base
...
save $country_folder/CY_wip.dta, replace
...
logit singleb i.corr_ben i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*doesn't work
tabstat MAD, by(MAD_conformitiy) stat(min mean max)

xtile ben=MAD if filter_ok==1, nquantiles(10)
replace ben=99 if MAD==. 
mean MAD if filter_ok //0.0125514  
tabstat MAD if filter_ok, stat(mean median) //median .010421
tabstat MAD, by(ben) stat(min max)

*compared to mean
logit singleb ib7.ben i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*10

tab MAD_conformitiy if inlist(ben,10) //OK!
tabstat MAD if inlist(ben,10), stat(min max) //OK!
...
logit singleb i.corr_proc  i.corr_decp i.corr_submp i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*R2 29.7%, 8,402 obs
...
save $coutnry_folder/CY_wb_2011.dta, replace
********************************************************************************

*CRI calculation
sum singleb corr_proc corr_submp corr_decp   proa_ycsh if filter_ok==1
tab singleb, m
...
do $utility_codes/cri.do ssingleb corr_proc_bi corr_subm_bi corr_decp_bi proa_ycsh4
rename cri cri_cy

sum cri_cy if filter_ok==1
hist cri_cy if filter_ok==1, title("CRI CY, filter_ok")
hist cri_cy if filter_ok==1, by(tender_year, noiy title("CRI CY (by year), filter_ok")) 
********************************************************************************
