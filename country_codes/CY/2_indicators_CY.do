...
*Use buyer_masterid and bidder_masterid
...
************************************************
*Reload working data to merge benford data
...
do "${utility_codes}/cri.do" singleb corr_proc_bi corr_subm_bi corr_decp_bi proa_ycsh4
rename cri cri_cy

// sum cri_cy if filter_ok==1
// hist cri_cy if filter_ok==1, title("CRI `country', filter_ok")
// hist cri_cy if filter_ok==1, by(tender_year, noiy title("CRI `country' (by year), filter_ok"))
********************************************************************************
