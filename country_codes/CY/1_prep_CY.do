...
// tab bid_iscons , m //only 2 obs
// tab tender_isframe , m //942
// tab opentender , m //942
// tab source , m //942
...
// br tender_id tender_lotscount lot_row_nr tender_recordedbidscount lot_bidscount  buyer_name bidder_name bidder_name bid_price tender_isframework if tender_id=="06e35aa7-a7e2-4cae-8d63-e38f08461a0a"
...
********************************************************************************
*Reload data to merge the ppp data
...
drop if _m==2 //dropping unmatched ppp values from using dataset
...
****************************
*digiwhist price same as bid_price
...
// tab buyer_city, m
// tab buyer_nuts, m
*Doesn't make sense to use the location control - skip
************************************
*Tender year
...
*Clean Market id
// tab market_id, m
*There are two product codes systems in data possibly old and new CPV codes
*Relying on CPV2008

*Checking that market id only contains correct CPV sectors
