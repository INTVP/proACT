...
*Data
use $country_folder/wb_lv_cri201203.dta, clear
********************************************************************************
...
foreach var of varlist singleb corr_crit corr_submp corr_proc nocft taxhav2 {
tab `var', m
gen ind_`var'_val = 0 
