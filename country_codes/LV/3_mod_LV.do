...
replace buyer_country = "LV" if inlist(buyer_country,"1","4","0","")
replace bidder_country = "LV" if inlist(bidder_country,"1","4","0")
replace bidder_country = ustrregexra(bidder_country,"[\d]","")
************************************
*Calcluating indicators

foreach var of varlist singleb corr_submp corr_proc nocft taxhav2 {
// tab `var', m
gen ind_`var'_val = 0 
