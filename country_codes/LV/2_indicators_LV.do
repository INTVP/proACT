...
tab singleb
tab singleb if filter_ok , missing  //26.9% singlebidding
********************************************************************************
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="LV" | bidder_country==""
tab fsuppl, missing
...
/*Close conformity — 0.0053575 to 0.0054057
Acceptable conformity — 0.0068166 to 0.0119098
Marginally acceptable conformity — 0.0120475 to 0.0149341
Nonconformity — greater than 0.0150489
*/
...
*94.42% has 0 published documents
********************************************************************************
...
*number of obs = 249,200, Pseudo R2 = 0.1052
********************************************************************************
*procedure types
...
logit singleb ib7.ca_procedure i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base

*there are only 16 obs COMPETITIVE_DIALOG
gen corr_proc=.
replace corr_proc=0 if ca_procedure==7 | ca_procedure==10
replace corr_proc=1 if ca_procedure>=4 & ca_procedure<=6 | ca_procedure==9 | ca_procedure==1
...
*21.24% of the contracts had no call for tenders
...
gen submp3=.
replace submp3=1 if submp<15 & submp!=.
replace submp3=2 if submp>=15 & submp<24 & submp!=.
replace submp3=3 if submp>=24 & submp!=.
...
logit singleb i.nocft ib3.submp3 i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & corr_proc==0, base
...
logit singleb ib3.decp5 i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base

gen corr_decp=.
replace corr_decp=0 if decp10>=5 & decp10!=99
replace corr_decp=1 if decp10==3 | decp10==4 & decp10!=99
...
*little variance, 91.35% of tenders have no modification
********************************************************************************

*published documents
tab tender_documents_count if filter_ok==1
*94.76% has 0 published documents
...
logit singleb i.ten_doc2 i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base
...
logit singleb ib2.corr_ben i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base
*counterint.
...
logit singleb i.ben5 i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base
logit singleb i.ben10 i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base
*still doesn't work
********************************************************************************
...
reg w_ycsh singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & w_ynrc>2 & w_ynrc!=., base
reg w_ycsh singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & w_ynrc>4 & w_ynrc!=., base
*singleb, corr_crit works
...
reg proa_ycsh singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & proa_ynrc>4 & proa_ynrc!=., base
reg proa_ycsh singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & proa_ynrc>9 & proa_ynrc!=., base
*singleb, nocft, decision period works
********************************************************************************

*** final best regression and valid red flags
logit singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1, base
*12.41% explanatory power

reg proa_ycsh singleb i.corr_decp i.nocft i.corr_submp i.corr_crit i.corr_proc i.ca_contract_value10 i.anb_type i.anb_loc i.tender_year i.ca_type i.marketid if filter_ok==1 & proa_ynrc>4 & proa_ynrc!=., base
*singleb, nocft, decision period works, 12.27%
********************************************************************************

*CRI generation
sum singleb corr_proc nocft corr_decp corr_submp corr_crit taxhav2 proa_ycsh if filter_ok==1
...
do $utility_codes/cri.do singleb corr_proc corr_submp nocft corr_decp_bi corr_crit taxhav2 proa_ycsh4 
rename cri cri_lv

sum cri_lv if filter_ok==1
hist cri_lv if filter_ok==1, title("CRI LV, filter_ok")
hist cri_lv if filter_ok==1, by(tender_year, noiy title("CRI LV (by year), filter_ok")) 
********************************************************************************

save $country_folder/wb_lv_cri201203.dta, replace
********************************************************************************
*END