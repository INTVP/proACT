...
*Data
use $country_folder/AT_wb_1020.dta, clear
********************************************************************************
...
foreach var of varlist nocft singleb corr_decp corr_ben{
tab `var', m
gen ind_`var'_val = 0 
...
foreach var of varlist corr_proc corr_submp {
tab `var', m
...
save $country_folder/AT_wb_1020.dta, replace
********************************************************************************

*Prep for Reverse tool
use $country_folder/AT_wb_1020.dta, clear

gen tender_country = "AT"
...
export delimited $country_folder/AT_mod.csv, replace
********************************************************************************
*END