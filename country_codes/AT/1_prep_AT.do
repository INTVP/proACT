...
*Data 
import delimited using  $utility_data/country/AT/starting_data/AT_data.csv , encoding(UTF-8) clear
********************************************************************************
...
tab filter_ok, m
tab bid_iswinning filter_ok, m
sum bid_digiwhist_price if filter_ok==0
*contract values are missing too
...
*tab curr if filter_ok
save $country_folder/AT_wip.dta , replace
************************************
