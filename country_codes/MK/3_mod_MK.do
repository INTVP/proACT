...
*Data
use $country_folder/MK_wb_1020.dta, clear
********************************************************************************
*Calcluating indicators

*For indicators with 1 category
foreach var of varlist nocft singleb taxhav corr_proc {
tab `var', m
gen ind_`var'_val = 0 
...
export delimited $country_folder/MK_mod.csv, replace
********************************************************************************
*END