...
*in 136,487 cases cft_deadline is missing when aw_date is present
*35687 when both values are available
...
preserve
    ...
    *rename xxxx ca_contract_value //bid price variable
    ...
    bys anb_id_addid: gen count = _N
    keep if count >100
    keep anb_id_addid ca_contract_value
	order anb_id_addid ca_contract_value
...
rename anb_id_addid anb_id_addid_orig
decode anb_id_addid_orig, gen(anb_id_addid)
merge m:1 anb_id_addid using $country_folder/buyers_benford.dta
drop if _m==2
drop _m 
...
do $utility_codes/cri.do singleb corr_proc_bi corr_desc corr_submp corr_ben_bi proa_ycsh4
rename cri cri_in
