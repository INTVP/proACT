...
*Data
use $country_folder/IS_wip.dta, clear
********************************************************************************
...
logit singleb ib6.ca_procedure i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Based on regressions 
*Level 1 risk - NA, COMPETITIVE_DIALOG, NEGOTIATED_WITHOUT_PUBLICATION, RESTRICTED 

label list ca_procedure2
cap drop corr_proc
gen corr_proc=.
replace corr_proc=0 if inlist(ca_procedure,3,5,6) 
replace corr_proc=1 if inlist(ca_procedure,1,2,4,7)
...
sum submp if filter_ok  //mean 84.5 days
tabstat submp if filter_ok,stat(mean median) //median 48
xtile submp10=submp if filter_ok==1, nquantiles(10)
replace submp10=99 if submp==.
tabstat submp, by(submp10) stat(min mean max n)

*Compared to mean
logit singleb ib38.submp10 i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok & ca_procedure==6, base 

cap drop corr_submp
gen corr_submp=0
replace corr_submp=1 if inlist(submp10,1)
...
*Not valid
*No variation outside the open procedures
drop corr_submp
********************************************************************************
...
logit singleb i.nocft i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
/*
...
logit singleb i.nocft2 i.corr_proc i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*doesn't work
/*
logit singleb i.nocft2##i.corr_proc  i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
...
tabstat decp if filter_ok,stat(n min mean max median)  //mean: 54.8 days median: 40
tabstat decp, by(decp10) stat(n min mean max)  

*compared to mean
logit singleb ib7.decp10 i.corr_proc i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High risk: 1
logit singleb ib8.decp10 i.corr_proc i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High risk: 1
*compared to median
logit singleb ib5.decp10 i.corr_proc i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*High risk: 1,2,3,10,99

cap drop corr_decp
gen corr_decp=0
replace corr_decp=1 if inlist(decp10,1,2,3,10,99)
...
logit singleb i.corr_decp i.corr_proc i.anb_location i.ca_contract_value10  i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*Valid!
...
gen fsuppl=1 
replace fsuppl=0 if bidder_country=="IS" | bidder_country==""
tab fsuppl, missing
...
logit singleb i.taxhav i.corr_proc  i.corr_decp  i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO -  doesn't converge
logit singleb i.taxhav2 i.corr_proc  i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
logit singleb i.taxhav3 i.corr_proc  i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*NO
...
reg w_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>2 & w_ynrc!=., base
*singleb
reg w_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>4 & w_ynrc!=., base
*no observations
reg w_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & w_ynrc>9 & w_ynrc!=., base
*no observations
...
*validation 
reg proa_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id if filter_ok  & proa_ynrc>2 & proa_ynrc!=., base
* proc
reg proa_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id if filter_ok  & proa_ynrc>4 & proa_ynrc!=., base
*proc
reg proa_ycsh singleb  i.corr_proc i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok  & proa_ynrc>9 & proa_ynrc!=., base
*proc
...
save $country_folder/IS_wip.dta, replace
...
logit singleb i.corr_ben  i.corr_proc  i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
...
logit singleb i.corr_proc  i.corr_decp i.anb_location i.ca_contract_value10 i.anb_type i.ca_type i.tender_year i.market_id  if filter_ok, base
*R2 36.5%, 1,551 obs
...
*CRI calculation
sum singleb  corr_proc corr_decp  proa_ycsh if filter_ok==1
tab singleb, m
tab corr_proc, m  
tab corr_decp, m 


do $utility_codes/cri.do singleb corr_proc corr_decp proa_ycsh4
rename cri cri_is

sum cri_is if filter_ok==1
hist cri_is if filter_ok==1, title("CRI IS, filter_ok")
hist cri_is if filter_ok==1, by(tender_year, noiy title("CRI IS (by year), filter_ok")) 
********************************************************************************

save $country_folder/IS_wb_2011.dta, replace
********************************************************************************
*END