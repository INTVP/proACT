...
*Data
use $country_folder/IS_wb_2011.dta, clear
********************************************************************************
...
foreach var of varlist singleb corr_decp corr_proc {
tab `var', m
gen ind_`var'_val = 0 
...
export delimited $country_folder/IS_mod.csv, replace
********************************************************************************
*END