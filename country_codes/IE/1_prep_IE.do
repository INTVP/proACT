...
*Data 
import delimited using  $utility_data/country/AT/starting_data/IE_data.csv, encoding(UTF-8) clear

********************************************************************************
*Main Filter & Data checks 

tab bid_iswinning , m //no losing
tab bid_iscons , m //only 185 obs 
...
save $country_folder/IE_wip.dta, replace
...
use $country_folder/IE_wip.dta, clear
...
gen anb_location1=buyer_nuts if regex(buyer_nuts,"^IE") 
replace anb_location1="EXT" if regex(anb_location1,"^IE")==0 & !missing(buyer_nuts)
