...
*Data
use $country_folder/IE_wb_2011.dta, clear
********************************************************************************

*Calcluating transparency indicators
...
foreach var of varlist singleb nocft2 corr_submp corr_proc {
tab `var', m
gen ind_`var'_val = 0 
...
drop if _m==2
tab buyer_nuts if _m==1 //all good 
...
merge m:1 nutscode using $utility_data/nuts_map.dta 
drop if _m==2
tab bidder_nuts if _m==1 //- 47 bad obs replace to missing
...
merge m:1 nutscode using $utility_data/nuts_map.dta
drop if _m==2
tab tender_addressofimplementation_n if _m==1  // 6 bad obs
...
drop market_id_star
split tender_cpvs, p(",")
drop tender_cpvs2-tender_cpvs216
...
************************************
save $country_folder/IE_wb_2011.dta, replace
********************************************************************************
...
export delimited $country_folder/IE_mod.csv, replace
********************************************************************************
*END