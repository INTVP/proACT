...
*Data
use $country_folder/HR_wb_1020.dta, clear
********************************************************************************
...
foreach var of varlist nocft singleb corr_proc corr_submp taxhav{
tab `var', m
gen ind_`var'_val = 0 
...
replace buyer_country=="HR" if buyer_country=="Hrvatska"
replace bidder_country=="HR" if bidder_country=="Hrvatska"
replace tender_addressofimplementation_c = ustrupper(tender_addressofimplementation_c)
********************************************************************************

export delimited $country_folder/HR_mod.csv, replace
********************************************************************************
*END